...
#   OLLAMA_MODEL      — Ollama model(s) to pull (space-separated, default: gemma4:31b)
...
RS_INSTALL_OLLAMA="${RS_INSTALL_OLLAMA:-1}"
RS_LAUNCH_COMFY="${RS_LAUNCH_COMFY:-1}"
RS_NODE_PACKS="${RS_NODE_PACKS:-vhs controlnet_aux essentials ltxvideo sam3}"
