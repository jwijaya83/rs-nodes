...
# 31b is the higher-quality option for the RTX PRO 6000's 96 GB VRAM;
# the workflows reference 26b but anything you `ollama pull` here is
# usable just by typing the right name in the RSPromptFormatter widget.
