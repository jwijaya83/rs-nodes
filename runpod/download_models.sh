...
#   * ltx-2.3-22b-dev-fp8.safetensors — does NOT exist on Lightricks/LTX-2.3
#     or Comfy-Org/ltx-2 as of 2026-05. If you need it, scp from local:
#       scp -P <port> -i ~/.ssh/id_ed25519 \
#         "E:\Comfy\models\checkpoints\ltx-2.3-22b-dev-fp8.safetensors" \
#         root@<ip>:/workspace/ComfyUI/models/checkpoints/
# -----------------------------------------------------------------------------
MODELS=(
    "checkpoints|ltx-2.3-22b-dev.safetensors|https://huggingface.co/Lightricks/LTX-2.3/resolve/main/ltx-2.3-22b-dev.safetensors"
